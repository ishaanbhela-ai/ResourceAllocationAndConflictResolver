...
// ============================================================
// FILE: src/components/Admin/Resources/EditResourceForm.jsx
// ============================================================
...
const EditResourceForm = ({ resource, onClose, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`/api/admin/resources/${resource.id}`, {
                ...formData,
            ...
            setApiError(err.response?.data?.message || 'Failed to update resource');
            setLoading(false);
        }
    };
